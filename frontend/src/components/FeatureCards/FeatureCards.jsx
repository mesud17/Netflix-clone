...
const features = [
  {
    ...
    icon: (
      /* Dark TV monitor with a reddish/purple screen glow */
      <svg viewBox="0 0 200 180" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <radialGradient id="screenGlow" cx="60%" cy="40%" r="65%" fx="65%" fy="35%">
          ...
          <linearGradient id="standGradient" x1="50%" y1="0%" x2="50%" y2="100%">
        ...
        <path d="M 62,150 Q 100,138 138,150 L 138,153 Q 100,143 62,153 Z" fill="url(#standGradient)" opacity="0.9" />
        <path d="M 94,118 L 106,118 L 103,142 L 97,142 Z" fill="url(#standGradient)" />
        <rect x="40" y="30" width="120" height="88" rx="4" fill="#1b1220" stroke="url(#frameBorder)" strokeWidth="1.5" />
        <rect x="43" y="33" width="114" height="76" rx="2" fill="url(#screenGlow)" />
        <path d="M 43,55 L 115,33 L 140,33 L 43,63 Z" fill="#ffffff" opacity="0.08" />
        <path d="M 70,109 L 157,45 L 157,60 L 88,109 Z" fill="#ffffff" opacity="0.04" />
        <rect x="40" y="109" width="120" height="9" rx="1" fill="#4d163d" opacity="0.4" />
  ...
  },
  {
    ...
    icon: (
      ...
      <circle cx="75" cy="75" r="48" fill="#a44eff" opacity="0.5" filter="url(#outer-glow)" />
    
      <circle cx="75" cy="75" r="46" fill="url(#button-grad)" filter="url(#inner-shadow)" />
    
      <circle cx="75" cy="75" r="45.5" fill="none" stroke="white" stroke-opacity="0.25" stroke-width="1" />
    
      <g transform="translate(75, 75)">
        <path d="M 0,-18 L 0,14 M 0,14 L -12,2 M 0,14 L 12,2" 
              fill="none" 
  ...
  },
  {
    ...
    icon: (
      /* Red-pink telescope with tiny background sparkles */
      <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Tiny red decorative stars */}
        <path d="M 24,70 L 26,72 L 24,74 L 22,72 Z" fill="#e61a4c" />
        <path d="M 82,32 L 83.5,33.5 L 82,35 L 80.5,33.5 Z" fill="#e61a4c" />
        <path d="M 32,25 L 35,28 L 32,31 L 29,28 Z" fill="#ff4d79" opacity="0.8" />
        
        {/* Telescope structure angled upward right */}
        <g transform="rotate(-36 50 50)">
          {/* Base Stand */}
          <line x1="38" y1="62" x2="32" y2="80" stroke="#540722" strokeWidth="4" strokeLinecap="round"/>
          <line x1="42" y1="62" x2="48" y2="78" stroke="#540722" strokeWidth="3" strokeLinecap="round"/>
          ...
          <line x1="46" y1="38" x2="46" y2="43" stroke="#400318" strokeWidth="3" />
        </g>
      </svg>
    ),
  },
    ...
    icon: (
      ...
      <svg viewBox="0 0 110 100" xmlns="http://www.w3.org/2000/svg">
        ...
        <g transform="translate(14, 12)">
          <rect x="0" y="0" width="52" height="52" rx="12" fill="url(#bgBack)" />
          <circle cx="18" cy="20" r="3.5" fill="#401833" />
          <circle cx="34" cy="20" r="3.5" fill="#401833" />
          <path d="M 15,34 Q 26,41 37,34" fill="none" stroke="#401833" strokeWidth="3.5" strokeLinecap="round" />
        </g>

        {/* Front Profile Dominant */}
        <g transform="translate(42, 34)">
          <rect x="0" y="0" width="54" height="54" rx="14" fill="url(#bgFront)" stroke="#161124" strokeWidth="3" />
          <circle cx="18" cy="20" r="3.5" fill="#ffffff" />
          <circle cx="36" cy="20" r="3.5" fill="#ffffff" />
          <path d="M 14,33 Q 27,44 40,33" fill="none" stroke="#ffffff" strokeWidth="4" strokeLinecap="round" />
        </g>
      </svg>
    ),
  },
